...
const ContactHero: React.FC<ContactHeroProps> = ({
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://linkedin.com/company/acm-rvce", label: "LinkedIn" },
  ...
  return (
    <>
      ...
      <section className={cn("relative w-full h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-white dark:bg-black", className)}>
        {/* Background Grid and Gradients */}
        <div className="absolute inset-0 z-0 opacity-40 dark:opacity-20 animate-bg-pan" style={{backgroundImage: `radial-gradient(circle at 50% 50%, transparent, var(--background)), radial-gradient(circle at 10% 20%, #0466c830, transparent 30%), radial-gradient(circle at 90% 80%, #0353a420, transparent 30%)`}}></div>
        ...
        >
          <img
            ...
            onError={(e) => { e.currentTarget.src = 'https://placehold.co/1280x720/1E293B/FFFFFF?text=Team+Photo'; e.currentTarget.onerror = null; }}
          />
        </motion.div>
      </section>
    </>
